...
def launch_sim(param_dict):
    ...
    box_constraints  = [-3,3]   # should depend on grid size and dt
    ...
    nc_control_data['c_array'] = 0*controlHandler.control_data['c_array']
...
def save_output_fig(name_folder,output_data):
    ...
    ax2.set_title(r'$\textrm{Control - } u_1(\theta,t)$',fontsize=20)
